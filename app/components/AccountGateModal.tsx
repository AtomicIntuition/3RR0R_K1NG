      ...
      <div className="p-8">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className={clsx(
              ...
              'bg-void-100 border border-void-200 rounded-lg',
              'text-gray-200 font-medium',
              'hover:bg-void-200 hover:border-void-100 transition-colors',
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-void-50 text-gray-500">or</span>
          </div>
        </div>
