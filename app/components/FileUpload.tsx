...
export function FileUpload({ className }: FileUploadProps) {
  ...
  return (
    <div className={clsx('w-full max-w-2xl mx-auto', className)}>
      {/* Header */}
      <div className="flex items-center gap-2 px-4 py-2 bg-gray-800 rounded-t-xl border border-b-0 border-gray-800">
      ...
      <div
        {...getRootProps()}
        className={clsx(
          'relative bg-gray-900 border border-gray-800 rounded-b-xl overflow-hidden',
          ...
          {isUploading ? (
            ...
            <>
              ...
              {isDragActive ? (
                ...
                <>
                  <p className="text-gray-50 mb-2 text-lg">
      ...
      <div className="mt-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2 text-xs">
          <span className="px-3 py-1 bg-gray-800 rounded-lg border border-gray-700 text-gray-400">
