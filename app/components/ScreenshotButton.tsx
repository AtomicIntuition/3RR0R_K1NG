...
export function ScreenshotButton({
  ...
  return (
    <button
      ...
      className={`screenshot-ignore flex items-center gap-2 px-4 py-2 bg-terminal/10 border border-terminal/30 text-terminal rounded-lg hover:bg-terminal/20 transition-all disabled:opacity-50 ${className || ''}`}
