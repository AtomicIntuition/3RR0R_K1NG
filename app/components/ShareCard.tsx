    ...
    <div className={clsx('bg-gray-900 rounded-xl border border-gray-800 p-6 shadow-sm', className)}>
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#1DA1F2]/10 border border-[#1DA1F2]/30 text-[#1DA1F2] rounded-lg hover:bg-[#1DA1F2]/20 transition-colors"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#0A66C2]/10 border border-[#0A66C2]/30 text-[#0A66C2] rounded-lg hover:bg-[#0A66C2]/20 transition-colors"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
