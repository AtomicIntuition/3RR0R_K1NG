...
const URLIllustration = () => (
  <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
    {/* Browser window */}
    <rect x="10" y="15" width="60" height="50" rx="6" fill="#27272A" stroke="#3F3F46" strokeWidth="2"/>
    {/* Browser header */}
    <rect x="10" y="15" width="60" height="12" rx="6" fill="#18181B"/>
    <rect x="10" y="21" width="60" height="6" fill="#18181B"/>
    {/* Traffic lights */}
    <circle cx="18" cy="21" r="2" fill="#FF5F57"/>
    <circle cx="25" cy="21" r="2" fill="#FEBC2E"/>
    <circle cx="32" cy="21" r="2" fill="#28C840"/>
    {/* URL bar */}
    <rect x="16" y="33" width="48" height="8" rx="4" fill="#18181B" stroke="#3F3F46"/>
    {/* Globe icon */}
    <circle cx="22" cy="37" r="2" stroke="#10B981" strokeWidth="1.5" fill="none"/>
    <path d="M20 37h4M22 35v4" stroke="#10B981" strokeWidth="0.75"/>
    {/* URL text line */}
    <rect x="27" y="35" width="32" height="4" rx="2" fill="#10B981" fillOpacity="0.2"/>
    {/* Content lines */}
    <rect x="16" y="48" width="32" height="3" rx="1.5" fill="#3F3F46"/>
    <rect x="16" y="54" width="24" height="3" rx="1.5" fill="#3F3F46"/>
  </svg>
);
...
const ScanIllustration = () => (
  <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
    {/* Radar circle */}
    <circle cx="40" cy="40" r="28" stroke="#3F3F46" strokeWidth="2" fill="#27272A"/>
    <circle cx="40" cy="40" r="20" stroke="#3F3F46" strokeWidth="1.5" strokeDasharray="4 4" fill="none"/>
    <circle cx="40" cy="40" r="12" stroke="#3F3F46" strokeWidth="1" strokeDasharray="2 2" fill="none"/>
    {/* Radar sweep */}
    <path d="M40 40L40 12" stroke="#10B981" strokeWidth="2" strokeLinecap="round">
      <animateTransform
...
const AIIllustration = () => (
  <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
    ...
    />
    {/* Neural connections */}
    <circle cx="32" cy="32" r="4" fill="#10B981" fillOpacity="0.2" stroke="#10B981" strokeWidth="1.5"/>
    <circle cx="48" cy="32" r="4" fill="#10B981" fillOpacity="0.2" stroke="#10B981" strokeWidth="1.5"/>
    <circle cx="40" cy="42" r="4" fill="#10B981" fillOpacity="0.2" stroke="#10B981" strokeWidth="1.5"/>
    ...
    {/* Connection lines */}
    <line x1="32" y1="32" x2="40" y2="42" stroke="#10B981" strokeWidth="1.5" strokeDasharray="2 2">
      <animate attributeName="stroke-dashoffset" from="0" to="8" dur="1s" repeatCount="indefinite"/>
    </line>
    <line x1="48" y1="32" x2="40" y2="42" stroke="#10B981" strokeWidth="1.5" strokeDasharray="2 2">
      <animate attributeName="stroke-dashoffset" from="0" to="8" dur="1s" repeatCount="indefinite"/>
    </line>
    <line x1="32" y1="32" x2="48" y2="32" stroke="#10B981" strokeWidth="1" strokeDasharray="2 2">
      <animate attributeName="stroke-dashoffset" from="0" to="8" dur="1s" repeatCount="indefinite"/>
    </line>
    {/* Sparkles */}
    <path d="M24 24l2 4 2-4-2-4-2 4z" fill="#10B981">
      <animate attributeName="opacity" values="0;1;0" dur="2s" repeatCount="indefinite"/>
    </path>
    <path d="M56 28l1.5 3 1.5-3-1.5-3-1.5 3z" fill="#10B981">
...
const ReportIllustration = () => (
  <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
    {/* Document */}
    <rect x="16" y="12" width="48" height="56" rx="4" fill="#27272A" stroke="#3F3F46" strokeWidth="2"/>
    {/* Header */}
    ...
    <rect x="44" y="30" width="8" height="20" rx="2" fill="#10B981" fillOpacity="0.3"/>
    <rect x="44" y="34" width="8" height="16" rx="2" fill="#10B981"/>
    <rect x="55" y="30" width="8" height="20" rx="2" fill="#34C759" fillOpacity="0.3"/>
    <rect x="55" y="36" width="8" height="14" rx="2" fill="#34C759"/>
    {/* Fix items */}
    <rect x="22" y="54" width="36" height="4" rx="2" fill="#3F3F46"/>
    <rect x="22" y="60" width="28" height="4" rx="2" fill="#3F3F46"/>
    {/* Checkmark badge */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {steps.map((step, index) => (
          <div
            key={step.number}
            className={clsx(
              'relative bg-gray-900 rounded-2xl border border-gray-800 p-6',
          ...
          >
            ...
            {/* Title */}
            <h3 className="font-semibold text-gray-50 mb-2 text-center">
              {step.title}
            </h3>
            ...
            {index < steps.length - 1 && (
              <div className="hidden lg:block absolute top-1/2 -right-3 w-6 h-0.5 bg-gradient-to-r from-gray-800 to-gray-900" />
            )}
          </div>
        ))}
      </div>
